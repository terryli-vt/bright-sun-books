...
const drizzle_1 = require("./drizzle"); // Import the Drizzle database connection
const schema_1 = require("./schema"); // Import the schema
function seedDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log("Resetting database...");
            // Delete all records from books and categories tables
            yield drizzle_1.db.delete(schema_1.books);
            yield drizzle_1.db.delete(schema_1.categories);
            ...
            */
            // Insert Categories
            const insertedCategories = yield drizzle_1.db
            ...
            // Insert Books
            const insertedBooks = yield drizzle_1.db
                ...
                /* Art Books */
                {
                    ...
                    price: 14.2,
                    imageUrl: "https://i.postimg.cc/Z5J4mVf7/Accidentally-Wes-Anderson.jpg",
                },
                {
                    ...
                    categoryId: insertedCategories[0].id,
                    price: 15.39,
                    imageUrl: "https://i.postimg.cc/PJGnR4pM/Everyday-Watercolor-Learn-to-Paint-Watercolor-in-30-Days.jpg",
                },
                {
                    title: "The Rise",
                    author: "Sarah Lewis",
                ...
                /* Business Books */
                {
                    ...
                    price: 13.71,
                    imageUrl: "https://i.postimg.cc/W3qP8K33/How-to-Win-Friends-and-Influence-People.jpg",
                },
                {
                    ...
                    categoryId: insertedCategories[1].id,
                    price: 30.2,
                    imageUrl: "https://i.postimg.cc/QCpZGTcZ/Leadership-Theory-and-Practice.jpg",
                },
                {
                    ...
                    categoryId: insertedCategories[1].id,
                    price: 18.99,
                    imageUrl: "https://i.postimg.cc/hPgHQh9h/Think-Again-The-Power-of-Knowing-What-You-Don-t-Know.jpg",
                },
                {
                    ...
                    categoryId: insertedCategories[1].id,
                    price: 10.99,
                    imageUrl: "https://i.postimg.cc/XqKmD00V/The-Richest-Man-in-Babylon.jpg",
                },
                /* Health Books */
                {
                ...
                },
                {
                    ...
                    categoryId: insertedCategories[2].id,
                    price: 14.2,
                    imageUrl: "https://i.postimg.cc/bJtKktCS/The-Easy-5-Ingredient-Ketogenic-Diet-Cookbook.jpg",
                },
                {
                ...
                },
                {
                    ...
                    categoryId: insertedCategories[2].id,
                    price: 14.48,
                    imageUrl: "https://i.postimg.cc/JzTVLmH0/Stretching-to-Stay-Young.jpg",
                },
                /* Science Books */
                {
                ...
                },
                {
                    ...
                    categoryId: insertedCategories[3].id,
                    price: 15.16,
                    imageUrl: "https://i.postimg.cc/LsXSYhFj/Chemistry-The-Central-Science.jpg",
                },
                {
                ...
                },
                {
                    ...
                    categoryId: insertedCategories[3].id,
                    price: 11.3,
                    imageUrl: "https://i.postimg.cc/6qqd2r5C/A-World-on-the-Wing-The-Global-Odyssey-of-Migratory-Birds.jpg",
                },
                /* Travel Books */
                {
                    ...
                    price: 21.26,
                    imageUrl: "https://i.postimg.cc/TYJvtnRr/Nomadland-Surviving-America-in-the-Twenty-First-Century.jpg",
                },
                {
                    ...
                    categoryId: insertedCategories[4].id,
                    price: 18.26,
                    imageUrl: "https://i.postimg.cc/GpH03NvQ/The-Bucket-List-1000-Adventures-Big-and-Small.jpg",
                },
                {
                    ...
                    categoryId: insertedCategories[4].id,
                    price: 11.16,
                    imageUrl: "https://i.postimg.cc/T32MFhwB/Lonely-Planet-Yellowstone-Grand-Teton-National-Parks.jpg",
                },
                {
